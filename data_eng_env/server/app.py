...
@app.get("/baseline")
def run_baseline():
    # End point to simulate running a baseline
    # Usually you'd expect a response showing the output of the baseline
    return {"message": "Run baseline_inference.py script locally to execute the baseline."}
